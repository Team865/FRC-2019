...
object LiftMotionPlanner {
    ...
    fun getCoolSetpoint(): Double = when (setpointLevel) {
        0 -> when (setpointType) {
            HatchCargo.Hatch -> FieldConstants.kHatch1Height - LiftConstants.kHatchIntakeHeight+3.0
            HatchCargo.Cargo -> FieldConstants.kCargo1Height
        }
        1 -> when (setpointType) {
            HatchCargo.Hatch -> FieldConstants.kHatch2Height - LiftConstants.kHatchIntakeHeight+3.0
            HatchCargo.Cargo -> FieldConstants.kCargo2Height
        }
        2 -> when (setpointType) {
            HatchCargo.Hatch -> FieldConstants.kHatch3Height - LiftConstants.kHatchIntakeHeight+3.0
